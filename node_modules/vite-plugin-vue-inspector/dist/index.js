...
var queryParserMiddleware = (req, _, next) => {
  var _a;
  if (!req.query && ((_a = req.url) == null ? void 0 : _a.startsWith(SERVER_URL))) {
  ...
  return {
    ...
    async load(id) {
      if (id === "virtual:vue-inspector-options") {
        ...
        if (query.type)
          return;
        return await import_fs2.default.promises.readFile(id, "utf-8");
      }
    },
    transform(code, id) {
...
import 'virtual:vue-inspector-path:load.js'` };
    ...
    configureServer(server) {
      ...
      (_a = server.httpServer) == null ? void 0 : _a.once("listening", () => {
        ...
        setTimeout(() => {
          console.log(`  > vite-plugin-vue-inspector: ${(0, import_kolorist.red)(`You can enter ${(0, import_kolorist.yellow)(toggleComboKey.replace(/\-/, "+"))} to toggle the Inspector`)}
`);
        }, 0);
      });
    },
